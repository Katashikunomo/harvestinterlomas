<footer class="page-footer" style="background: #113897;" itemprop="footer" itemscope itemtype="http://schema.org/WPFooter">
					...
					<div class="box-wrap">
						...
						<section class="quick-contact" >
							...
							<h2>Ingresa tu correo para recibir información</h2>
								...
								<button type="submit" style="background: #dba30b !important ; color: #fff;">Registrarme</button>
							</form>
						</section>
					</div>
			...
			<div class="footer-last-section">
				<div class="container">
					<p>Copyright 2023 &copy; Harvest Christian School <span> </p>
				</div>
			</div>
		</footer>
	...
	<script src="js/assets/nav-animation.js"></script>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
	<script src="styles/wsbtn.js"></script>

	<script src="js/agregations/marqueeSlider.js"></script>
