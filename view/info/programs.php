        <section  style="height: 100vh; width: 100%; ">
			...
			<div class="parallax ace-bann" style="position: absolute; background-image: url(images/educacion/ace.svg);  background-size: 100%; background-position: center; background-repeat: no-repeat; height: 100%; width: 99%; margin-top: 80px;"></div>
			<!-- <div class="card-ace"> 
				<p style="    padding: 20px;">información</p>
			</div>
			 -->
		</section>
